...
export function AppShell({ children, title, actions }: AppShellProps) {
  ...
  return (
    <div className="h-screen overflow-hidden bg-background">
      ...
      {/* Main Content */}
      <div className={`h-screen overflow-hidden flex flex-col transition-all duration-300 ${sidebarCollapsed ? "lg:pl-[68px]" : "lg:pl-64"}`}>
        {/* Desktop Header */}
        <header className="shrink-0 sticky top-0 z-30 hidden lg:flex h-12 items-center gap-4 border-b border-border bg-background/80 backdrop-blur-sm px-6">
          <button
